...
public:
    ...
    , couplingManager_(couplingManager)
    {
        ...
        initialSoluteMoleFraction_ = getParam<Scalar>("BoundaryConditions.InitialSoluteMoleFraction");
                     ...
                     const SubControlVolume &scv) const
    {
        ...
        const auto molarDensitySolute = 1000 / molarMassSolute_;
        sourceValues[transportEqIdx] += 2 * M_PI * rootRadius * diffusionCoefficientMembrane_ * (x1D - x3D) * molarDensitySolute;
    ...
    PrimaryVariables initialAtPos(const GlobalPosition &globalPos) const
    {
        ...
        const auto xTracer = [&]()
        {
            ...
            if ((globalPos - contaminationPos).infinity_norm() <  extend + eps_)
                return initialSoluteMoleFraction_;
            else
                return 0.0;
        }();
...
private:
    Scalar pcTop_, initialSoluteMoleFraction_;
